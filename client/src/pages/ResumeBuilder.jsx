...
const ResumeBuilder = () => {
  const { resumeId } = useParams(); // ✅ FIXED: Corrected missing parentheses
    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-8">
        <div className="grid lg:grid-cols-12 gap-8">
          {/* Left panel - form */}
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden bg-white shadow-sm border border-gray-200 p-6 pt-1">
            {/* Progress bar */}
            ...
            <div className="mt-6">
              ...
              <div className="flex justify-between items-center mb-6 border-b border-gray-300 py-1 ml-2">
