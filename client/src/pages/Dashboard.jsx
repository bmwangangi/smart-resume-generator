...
const Dashboard = () => {
  ...
  // Load existing resumes (placeholder)
  ...
  const createResume = async (event) => {
    ...
    try {
      ...
      navigate(`/app/builder/${data.resume?._id || data.resumeId}`);
    } catch (error) {
      toast.error(error?.response?.data?.message || error.message);
    }
  };
        ...
        {showUploadResume && (
          ...
          >
            ...
            >
             ...
             <button
                disabled={isLoading}
                className="w-full py-2 flex justify-center items-center gap-2 bg-green-600 text-white rounded hover:bg-green-700 transition-colors disabled:opacity-70"
              >
